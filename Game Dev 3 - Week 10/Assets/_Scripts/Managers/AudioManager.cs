...
namespace GameDevWithMarco.Managers
{
    public class AudioManager : Singleton<AudioManager>
    {
        ...
        {
            PlaySounds( goodPickupSoundData.minPitchValue, badPickupSoundData.maxPitchValue, 
                        goodPickupSoundData.clipToUse, goodPickupSoundData.soundVolume);
        }
        public void BadPickupSound()
        {
            PlaySounds( badPickupSoundData.minPitchValue, goodPickupSoundData.maxPitchValue, 
